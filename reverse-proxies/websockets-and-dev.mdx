...
description: 'Running SocialSyncs behind ngrok or a reverse proxy with WebSocket support'
---

## Production reverse proxy

How you reverse-proxy depends on how you're running SocialSyncs:
...
your redirect URI. SocialSyncs works around this by wrapping the redirect
...
**You only see this in dev.** Once `FRONTEND_URL` is HTTPS, SocialSyncs
