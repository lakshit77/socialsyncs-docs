...
SocialSyncs exposes an MCP server that provides **8 tools** to AI agents. The agent discovers these tools, understands their schemas, and calls them on your behalf.
