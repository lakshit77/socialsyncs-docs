...
SocialSyncs writes user-uploaded media (post images, avatars, generated
...
Set the path where SocialSyncs should write:
...
with TLS, you're fine. If SocialSyncs is on a private network, those
