...
SocialSyncs supports two email providers: Resend and NodeMailer (SMTP).
...
```env
EMAIL_FROM_NAME: "SocialSyncs Emailer"
EMAIL_FROM_ADDRESS: "socialsyncs@example.com"
```

## Resend

SocialSyncs uses Resend to send email notifications to users. If this key is set, users
