...
description: 'How to get started developing with SocialSyncs'
---

## Understand how to develop with SocialSyncs
...
SocialSyncs is an open-source project, and the source code is available on [GitHub](https://github.com/gitroomhq/postiz-app).
...
The SocialSyncs [contributors guide](https://github.com/gitroomhq/postiz-app/blob/main/CONTRIBUTING.md) is contained in the main repository. It provides information on how to contribute to the project, mainly the format for how to submit a pull request.
