...
These apply to SocialSyncs Cloud only.
...
- Allow third-party scripts on `platform.socialsyncs.co`.
...
SocialSyncs validates discount codes server-side against Stripe. If apply
fails, double-check:
...
- **Email:** see the contact section on [socialsyncs.co](https://socialsyncs.co).
