...
SocialSyncs marks it's login cookies as Secure, this is called "secure context" in modern web browsers.
...
- **5000/tcp**: for a single **single entry point** for socialsyncs when running in a container. This is the one port your reverse proxy should talk to.
...
graph TD;
	...
	subgraph "SocialSyncs Container"
