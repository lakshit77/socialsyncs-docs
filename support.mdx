---
title: Support
description: 'Get help with SocialSyncs'
---

Sometimes, things can go wrong, or you need some help!

Note that the Self Hosted version of SocialSyncs is supported by the community in their
...
<CardGroup cols={1}>
  <Card title="GitHub Issues" icon="github" href="https://github.com/gitroomhq/postiz-app/issues/new/choose">
    Report bugs and ask for help with the open-source app.
  </Card>
</CardGroup>

## SocialSyncs Cloud — billing & refunds

For questions specific to a paid SocialSyncs Cloud subscription (refunds,
...
- For anything that needs to be handled privately (refunds, account
  data, GDPR requests), see the contact section on [socialsyncs.co](https://socialsyncs.co).
