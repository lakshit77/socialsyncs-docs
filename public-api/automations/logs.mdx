...
curl -H "Authorization: your-api-key" \
  "https://app.socialsyncs.co/api/public/v1/automations/{id}/logs?limit=50"

# Next page
curl -H "Authorization: your-api-key" \
  "https://app.socialsyncs.co/api/public/v1/automations/{id}/logs?limit=50&cursor=your-cursor"
```
