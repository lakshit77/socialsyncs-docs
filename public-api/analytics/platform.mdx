...
curl -H "Authorization: your-api-key" \
  https://app.socialsyncs.co/api/public/v1/integrations

# Use the returned id
curl -H "Authorization: your-api-key" \
  https://app.socialsyncs.co/api/public/v1/analytics/<integration-id>
```

## Common errors

- `400 Invalid integration` — the path param is the wrong shape.
- `404 Channel not found` — the integration exists but has been disconnected. Reconnect the channel from the SocialSyncs UI.
