...
```bash
curl -H "Authorization: your-api-key" https://api.socialsyncs.co/public/v1/integrations
```
...
```bash
curl -H "Authorization: pos_your-oauth-token" https://api.socialsyncs.co/public/v1/integrations
```
...
|-------------|----------|
| SocialSyncs Cloud | `https://api.socialsyncs.co/public/v1` |
...
<Tabs>
  <Tab title="Cloud">
      <iframe src="https://platform.socialsyncs.co/modal/dark/all" style={{zoom: 0.5, height: 1000, width: '100%'}} />
      <a href="https://platform.socialsyncs.co/modal/dark/all" target="_blank" rel="noopener noreferrer" style={{display: 'block', marginTop: '10px', textAlign: 'center'}}>
         Open in full screen
      </a>
  </Tab>
