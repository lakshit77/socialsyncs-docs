...
<Steps>
  ...
  <Step title="Redirect Users to Authorize">
    ...
    **Example:**
    ...
    ```bash
    https://platform.socialsyncs.co/oauth/authorize?client_id=pca_VklHTpdEJ6dJ73FHQEJ97qVA0lcMDsrs&response_type=code&state=random123
    ```
...
const POSTIZ_URL = 'https://platform.socialsyncs.co';
const BACKEND_URL = 'https://api.socialsyncs.co';
