...
<Steps>
  ...
  <Step title="Fill in OAuth Details">
    ...
    **Your YouTube OAuth2 Redirect URI:**
    - Production: `https://your-socialsyncs-domain.com/integrations/social/youtube`
...
<Steps>
  ...
  <Step title="Wait for propagation">
    ...
    After this time you should now be able to add your YouTube channel to your SocialSyncs account
  </Step>
</Steps>
