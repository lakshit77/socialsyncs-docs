...
<Steps>
  ...
  <Step title="Configure OAuth2 Redirect URI">
    ...
    **Your LinkedIn Page OAuth2 Redirect URI:**
    - Production: `https://your-socialsyncs-domain.com/integrations/social/linkedin-page`
...
LinkedIn is the only provider SocialSyncs supports PDF posting on, and only through document-carousel posts. When you create a carousel of images on a LinkedIn Page, SocialSyncs combines the images into a PDF document and uploads it as a LinkedIn document share. You don't upload a PDF directly — SocialSyncs produces the PDF from your images.
