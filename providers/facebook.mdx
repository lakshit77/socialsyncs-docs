...
<Steps>
  ...
  <Step title="Configure redirect URI">
    ...
    **Your Facebook OAuth2 Redirect URI:**
    - Production: `https://your-socialsyncs-domain.com/integrations/social/facebook`
  ...
  <Step title="Request advanced permissions">
    ...
    <Note>
    If your SocialSyncs install is for personal use only these advanced permissions are not required for SocialSyncs to function.
    </Note>
  </Step>
