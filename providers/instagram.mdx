...
<Info>
**What SocialSyncs supports on Instagram:**
...
**What SocialSyncs does not support:**

- Story link stickers / swipe-up links — the Instagram Graph API doesn't expose interactive sticker payloads, so SocialSyncs can only upload the story media.
...
The following steps will guide you through the setup of a Meta application that can be used for connecting Instagram to SocialSyncs.
...
<Steps>
  ...
  <Step title="Set up Redirect URI">
    ...
    **Your Instagram OAuth2 Redirect URI:**
    - Production: `https://your-socialsyncs-domain.com/integrations/social/instagram`
...
<Steps>
  ...
  <Step title="Set up Redirect URI">
    ...
    **Your Instagram Standalone OAuth2 Redirect URI:**
    - Production: `https://your-socialsyncs-domain.com/integrations/social/instagram-standalone`
...
```
  ...
  <Step title="Add Instagram Standalone channel in SocialSyncs Application">
    Go to the SocialSyncs web interface, and click on the "Add Channel" button. Select "Instagram (Standalone)" from the list of available channels. You should be redirected to the Instagram login screen to authorize the application.
  </Step>
</Steps>
